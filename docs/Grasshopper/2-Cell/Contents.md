...
<em>Targets drawn in place, without reference (the default reference "Root", at the origin of the document, is assigned). These targets will be translated as they are.</em>

[<img src="../../assets/images/22TargetsAbsoluteReferenced.gif">](../../assets/images/22TargetsAbsoluteReferenced.gif)
<em>Targets drawn in place, with a reference. Their coordinates will be translated relative to the reference.</em>
...
<em>Targets relative to the reference: the targets are drawn at the document origin, then moved to a reference. Their coordinates will be translated relative to the reference.</em>
