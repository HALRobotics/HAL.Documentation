...
<em>Targets drawn in place, without reference (the default reference "Root", at the origin of the document, is assigned). Their coordinates will be translated to robot code as they are.</em>

[<img src="../../assets/images/22TargetsAbsoluteReferenced.gif">](../../assets/images/22TargetsAbsoluteReferenced.gif)
<em>Targets drawn in place, with a reference. Their coordinates relative to the reference will be translated to robot code.</em>
...
<em>Targets relative to the reference: the targets are drawn at the document origin, then moved to a reference. Their coordinates relative to the reference will be translated to robot code.</em>
